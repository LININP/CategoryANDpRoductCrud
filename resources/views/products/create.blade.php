...
<body>
  ...
  <form action="{{route('store_prodcts')}}" method="POST" enctype="multipart/form-data">
    @csrf
    ...
    <div class="form-group">
      ...
      <input type="text" id="product-name" name="product_title" placeholder="Enter product name" required>
    </div>
